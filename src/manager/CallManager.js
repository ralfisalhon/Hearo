/*
    This file is unedited from https://github.com/voximplant/react-native-demo/blob/master/src/manager/CallManager.js
    Date: Jul 27, 2018
*/
...
export default class CallManager {
    ...
    _incomingCall = (event) => {
        if (this.call !== null) {
            console.warn("CallManager: incomingCall: already have a call, rejecting new call, current call id " + this.call.callId);
            event.call.decline();
        } else {
